...
console.log(AbstractGraph.fromEdgesListDefault([[2,3]]).has_cycle2() == false);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,0]]).has_cycle2() == true);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,3],[3,0]]).has_cycle2() == true);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,4],[2,3],[3,1]]).has_cycle2() == true);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[3,4],[4,5]]).has_cycle2() == false);
