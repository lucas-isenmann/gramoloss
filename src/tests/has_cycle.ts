...
// console.log(AbstractGraph.fromEdgesListDefault([[2,3]]).hasCycle() == false);
// console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,0]]).hasCycle() == true);
// console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,3],[3,0]]).hasCycle() == true);
// console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,4],[2,3],[3,1]]).hasCycle() == true);
// console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[3,4],[4,5]]).hasCycle() == false);
...
console.log(AbstractGraph.fromEdgesListDefault([[2,3]]).hasCycle2()[0] == false);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,0]]).hasCycle2()[0] == true);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,3],[3,0]]).hasCycle2()[0] == true);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,4],[2,3],[3,1]]).hasCycle2()[0] == true);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[3,4],[4,5]]).hasCycle2()[0] == false);
console.log(AbstractGraph.fromEdgesListDefault([[0,1],[1,2],[2,3],[3,0],[0,4]]).hasCycle2()[1].length == 4);
