...
console.log(Graph.UGtournament(5,2).degreewidth()[0]);
console.log(Graph.UGtournament(7,3).degreewidth()[0]);

// Regular tournament => dw(2n+1) = n
console.log(Graph.Paley(19).degreewidth()[0]);

// U-tournament => dw(Un) = 1 if n >= 3
console.log(Graph.UGtournament(2, 1).degreewidth())
console.log(Graph.UGtournament(4, 1).degreewidth())
console.log(Graph.UGtournament(5, 1).degreewidth())
console.log(Graph.UGtournament(6, 1).degreewidth())
